...
public class MyArticlesAdapter extends RecyclerView.Adapter<MyArticlesAdapter.MyViewHolder> {

    private Context mContext;
    private List<Article> mData;

    public MyArticlesAdapter(Context mContext, List<Article> mData) {
